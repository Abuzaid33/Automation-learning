...
os.makedirs("Day-14/data", exist_ok=True)
...
class EmployeeDatabase:
    ...
    def create_employee(self):
        ...
        try:
            ...
            if os.path.exists("Day-14/data/employees.json"):

                with open("Day-14/data/employees.json", "r") as file:
            ...
            with open("Day-14/data/employees.json", "w") as file:
